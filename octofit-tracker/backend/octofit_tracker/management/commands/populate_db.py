...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Log data insertion
        logger.info("Inserted users: %s", users)
        logger.info("Inserted teams: %s", [team1, team2])
        logger.info("Inserted activities: %s", activities)
        logger.info("Inserted leaderboard entries: %s", leaderboard_entries)
        logger.info("Inserted workouts: %s", workouts)
